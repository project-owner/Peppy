  ...
  render() {
    ...
    return (
      <FormControl component="fieldset">
        ...
        {Factory.createNumberTextField("page.size", values, updateState, "", style, classes, labels)}
        {Factory.createTextField("topics", values, updateState, style1, classes, labels)}
      </FormControl>
    );
  }
}
