...
class IconHandler(PeppyRequestHandler):
    """ curl http://localhost:8000/api/icon?category=line&name=home&color1=(100,100,100)&color2=(200,200,200)
    """
    ...
    def get(self):
        try:
            ...
            img = self.image_util.load_svg_icon_main(type, name, c_1, c_2, category)
