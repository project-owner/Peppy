...
from monitorutil import HIGH, CODE_UNKNOWN, ICONS_FOLDER, BLACK, GENERATED_IMAGE, DEGREE_SYMBOL, UNKNOWN, DAY, CODE
...
class Forecast(Container):
    ...
    def draw_tile_icon(self, x, y, w, h, fcast):
        ...
        :param fcast: one day forecast
        """
        if not hasattr(fcast, "weather_icon_name"): return
    ...
    def draw_temp(self, x, y, w, h, fcast):
        ...
        if not hasattr(fcast, "temp"): return
    ...
    def draw_tile_header(self, x, y, w, h, fcast):
        ...
        if not hasattr(fcast, "ref_time"): return
