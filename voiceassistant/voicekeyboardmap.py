...
VOICE_KEYBOARD_MAP = {
    ...
    "VA_SAVER" : pygame.K_s,
    "VA_EQUALIZER" : pygame.K_r,
    "VA_TIMER" : pygame.K_a,
    "VA_NETWORK" : pygame.K_n,
    "VA_FAVORITES" : pygame.K_s,
    "VA_REFRESH" : pygame.K_s,
    "VA_EJECT" : pygame.p,
    "VA_MENU" : pygame.K_m,
    "VA_SLEEP" : pygame.K_s,
    "VA_SLEEP_NOW" : pygame.K_x,
    "VA_POWEROFF" : pygame.K_END,
    "VA_WAKE_UP" : pygame.K_ESCAPE,
    "VA_WI_FI_NETWORKS" : pygame.K_r,
    "VA_DISCONNECT_WI_FI" : pygame.K_p,
    "VA_SORT_NETWORKS" : pygame.K_p,
    "VA_DELETE_PASSWORD" : pygame.K_p,
    "VA_SHOW_PASSWORD" : pygame.K_s,
    "VA_HIDE_PASSWORD" : pygame.K_s,
    "VA_0" : pygame.K_0,
    "VA_1" : pygame.K_1,
    "VA_2" : pygame.K_2,
    "VA_3" : pygame.K_3,
