...
from util.keys import KEY_PLAYER, KEY_HOME, KEY_START_SAVER

class SaverNavigator(Navigator):
    ...
    def __init__(self, util, bounding_box, listeners):
        ...
        self.add_button(items, KEY_START_SAVER, None, [listeners[KEY_START_SAVER]])
        self.add_button(items, KEY_PLAYER, None, [listeners[KEY_PLAYER]])

        Navigator.__init__(self, util, bounding_box, "saver.navigator", items, None)
