...
from util.keys import GO_LEFT_PAGE, GO_RIGHT_PAGE, KEY_HOME, KEY_PLAYER, KEY_NETWORK, KEY_REFRESH

class BluetoothNavigator(Navigator):
    """ Bluetooth screen navigator """
    ...
    def __init__(self, util, bounding_box, listeners, pages):
        ...
        self.add_button(items, KEY_NETWORK, None, [listeners[KEY_NETWORK]])
        ...
        Navigator.__init__(self, util, bounding_box, "bluetooth.navigator", items, arrow_items)
