...
from util.keys import GO_LEFT_PAGE, GO_RIGHT_PAGE, KEY_HOME, KEY_PLAYER, KEY_BACK, GO_BACK

class PodcastNavigator(Navigator):
    """ Podcast navigator """
    ...
    def __init__(self, util, bounding_box, listeners, pages):
        ...
        Navigator.__init__(self, util, bounding_box, "podcast.navigator", items, arrow_items)
