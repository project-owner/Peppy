...
from util.keys import KEY_PLAYER, KEY_HOME, KEY_BACK, KEY_PLAYER, KEY_FAVORITES

class SearchByNavigator(Navigator):
    """ Radio Browser Search By Navigator """
    ...
    def __init__(self, util, bounding_box, listeners):
        ...
        self.add_button(items, KEY_FAVORITES, None, [listeners[KEY_FAVORITES]])
        self.add_button(items, KEY_PLAYER, None, [listeners[KEY_PLAYER]])

        Navigator.__init__(self, util, bounding_box, "radio.browser.search.by.navigator", items, None)
