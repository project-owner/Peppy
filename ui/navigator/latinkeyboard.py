...
from util.keys import KEY_HOME, KEY_PLAYER, KEY_BACK
from util.config import COLLECTION

class LatinKeyboardNavigator(Navigator):
    ...
    def __init__(self, util, bounding_box, listeners):
        ...
        Navigator.__init__(self, util, bounding_box, "latin.keyboard.navigator", items, None)
